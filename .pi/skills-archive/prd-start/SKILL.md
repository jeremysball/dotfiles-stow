...
> Example PRD numbers in this skill are placeholders. If a `prdNumber` argument is provided, it always wins. Otherwise, prefer the PRD most clearly established by the current conversation, branch, or modified files.
...
Please provide the PRD number (e.g., "<id>", "PRD <id>", or any valid PRD number).
